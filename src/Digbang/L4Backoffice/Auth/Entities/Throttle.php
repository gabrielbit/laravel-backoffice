...
class Throttle implements ThrottleInterface
{
     ...
     *
     * @type DoctrineThrottleRepository
     */
    private $throttleRepository;

    /**
     * @param DoctrineThrottleRepository $throttleRepository
     */
    public function setThrottleRepository(DoctrineThrottleRepository $throttleRepository)
    {
