...
class User implements UserInterface
{
     ...
     */
    public function setUserRepository(DoctrineUserRepository $userRepository)
    {
    ...
    public function validate()
    {
        ...
        {
            throw new UserExistsException("A user already exists with login [$this->email], logins must be unique for users.");
        }
